...
bool ovrp_Initialize5(RenderAPIType apiType, int *logCallBack, jobject *activity, int *OVRPInstance, int *OVRPPhysicalDevice, int *OVRPCommandQueue, int *initializeFlags)
{
    LogFunction(IMPLEMENTED, NORMAL, __func__);
